<?php
// source: /var/www/fakturace/app/config/config.neon 
// source: /var/www/fakturace/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/fakturace/app',
			'wwwDir' => '/var/www/fakturace/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/fakturace/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/fakturace/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/fakturace/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/fakturace/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/fakturace/app/../temp/cache', $this->getService('nette.cacheJournal'));
