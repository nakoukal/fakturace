<?php
// source: /media/sda1/www/fakturace/app/config/config.neon 
// source: /media/sda1/www/fakturace/app/config/config.local.neon 

/**
 * @property Fakturace\FakturaRepository $FakturaRepository
 * @property Fakturace\FirmaRepository $FirmaRepository
 * @property Fakturace\PraceRepository $PraceRepository
 * @property Fakturace\TypRepository $TypRepository
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'fakturace\\fakturarepository' => array('FakturaRepository'),
			'fakturace\\firmarepository' => array('FirmaRepository'),
			'fakturace\\pracerepository' => array('PraceRepository'),
			'fakturace\\typrepository' => array('TypRepository'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/media/sda1/www/fakturace/app',
			'wwwDir' => '/media/sda1/www/fakturace/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/media/sda1/www/fakturace/app/../temp',
		));
	}
	...
	/**
	 * @return Fakturace\FakturaRepository
	 */
	public function createService__FakturaRepository()
	{
		$service = new Fakturace\FakturaRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return Fakturace\FirmaRepository
	 */
	public function createService__FirmaRepository()
	{
		$service = new Fakturace\FirmaRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return Fakturace\PraceRepository
	 */
	public function createService__PraceRepository()
	{
		$service = new Fakturace\PraceRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return Fakturace\TypRepository
	 */
	public function createService__TypRepository()
	{
		$service = new Fakturace\TypRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/media/sda1/www/fakturace/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=fakturace', 'fakturace', 'fakturace', array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/media/sda1/www/fakturace/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/media/sda1/www/fakturace/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/media/sda1/www/fakturace/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/media/sda1/www/fakturace/app/../temp/cache', $this->getService('nette.cacheJournal'));
